            ...
            <div class="team_section clearfix">
                @foreach($peoples as $k => $people)
                    <div class="team_area">
                        ...
                        <h3 class="wow fadeInDown delay-0{{$k+3}}s">{{ $people->name }}</h3>
                        <span class="wow fadeInDown delay-0{{$k+3}}s">{{ $people->position }}</span>
                        <p class="wow fadeInDown delay-0{{$k+3}}s">{{ $people->text }}</p>
                    </div>
                @endforeach
            </div>
        </div>
...
<footer class="footer_wrapper" id="contact">
                ...
                <div class="col-lg-8 wow fadeInLeft delay-06s">
                    <div class="form">
                        <form action="{{ route('home.contact') }}" method="POST">
                            {{ csrf_field() }}
                            <input class="input-text has-error" type="text" name="name" placeholder="Your Name *" onFocus="if(this.value==this.defaultValue)this.value='';" onBlur="if(this.value=='')this.value=this.defaultValue;">
    ...
    <div class="container">
        <div class="footer_bottom"><span>Copyright © 2017,  created by <a href="https://github.com/kaharlykskyi">Kaharlykskyi Misha</a>. </span> </div>
    </div>
</footer>